...
<form method="POST" action="{{ route('role.update', $model->id) }}" class="form-horizontal">
    @csrf
    @method('PUT')
            ...
            <div class="tile-body">
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <label class="mb-0 d-flex align-items-center" style="cursor:pointer;gap:5px;">
                        <input type="checkbox" {{ $all_permissions == count($rolePermissions) ? 'checked' : '' }} id="checkAll"> Select All
                    </label>
                </div>
