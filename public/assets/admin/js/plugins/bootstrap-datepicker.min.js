...
!(function (a) {
    ...
    var j = (function () {
        ...
        k = function (b, c) {
            ...
            this.picker.find("tfoot .today, tfoot .clear").attr("colspan", function (a, b) {
                return parseInt(b) + 1;
            }),
    ...
    k.prototype = {
        ...
        _process_options: function (e) {
            ...
            if (
                (f.startDate !== -(1 / 0) &&
                (f.startDate ? (f.startDate instanceof Date ? (f.startDate = this._local_to_utc(this._zero_time(f.startDate))) : (f.startDate = r.parseDate(f.startDate, h, f.language))) : (f.startDate = -(1 / 0))),
        ...
        place: function () {
            ...
            this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"),
                "auto" !== this.o.orientation.x
                    ...
                    : n + b > f
                        ? (this.picker.addClass("datepicker-orient-right"), (n = k.left + m - b))
        ...
        getClassNames: function (b) {
            var c = [],
                ...
                g = new Date();
            return (
                b.getUTCFullYear() < d || (b.getUTCFullYear() === d && b.getUTCMonth() < f) ? c.push("old") : (b.getUTCFullYear() > d || (b.getUTCFullYear() === d && b.getUTCMonth() > f)) && c.push("new"),
            ...
            if (!isNaN(f) && !isNaN(g)) {
                ...
                for (var t, u = []; o.valueOf() < s; ) {
                    ...
                    if (((t = this.getClassNames(o)), t.push("day"), this.o.beforeShowDay !== a.noop)) {
                        ...
                        z === b ? (z = {}) : "boolean" == typeof z ? (z = { enabled: z }) : "string" == typeof z && (z = { classes: z }),
                ...
                for (
                    ...
                    if (((D = ["year"]), (d = null), -1 === F ? D.push("old") : 10 === F && D.push("new"), -1 !== a.inArray(f, E) && D.push("active"), (h > f || f > j) && D.push("disabled"), this.o.beforeShowYear !== a.noop)) {
                        ...
                        G === b ? (G = {}) : "boolean" == typeof G ? (G = { enabled: G }) : "string" == typeof G && (G = { classes: G }),
                        ...
                        (this.viewDate.setUTCDate(1),
                            g.hasClass("month")
                                ? ((f = 1),
                                    ...
                                    1 === this.o.minViewMode ? (this._setDate(c(d, e, f)), this.showMode()) : this.showMode(-1))
                                : ((f = 1), (e = 0), (d = parseInt(g.text(), 10) || 0), this.viewDate.setUTCFullYear(d), this._trigger("changeYear", this.viewDate), 2 === this.o.minViewMode && this._setDate(c(d, e, f)), this.showMode(-1)),
                            this.fill());
                        break;
                    case "td":
                        g.hasClass("day") &&
                        ...
                        ((f = parseInt(g.text(), 10) || 1),
                            ...
                            g.hasClass("old") ? (0 === e ? ((e = 11), (d -= 1)) : (e -= 1)) : g.hasClass("new") && (11 === e ? ((e = 0), (d += 1)) : (e += 1)),
