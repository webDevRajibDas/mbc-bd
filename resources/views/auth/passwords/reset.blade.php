...
<head>
    ...
    <title>Reset Password - POPI[HRMS]</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            min-height: 100vh;
            background: linear-gradient(135deg, #0C6B5E 0%, #084d44 50%, #063a33 100%);
            display: flex;
            align-items: center;
        ...
        .password-hints li.valid .hint-icon {
            color: #059669;
        }
...
<div class="login-card">
    ...
    <div class="login-form-panel">
        ...
        <div class="login-heading">রিসেট পাসওয়ার্ড</div>
        <div class="login-subheading">আপনার নতুন পাসওয়ার্ড সেট করুন</div>
        ...
        <form method="POST" action="{{ route('password.update') }}" id="resetForm" novalidate>
            ...
            <div class="field-group">
                ...
                <ul class="password-hints" id="passwordHints">
                    <li id="hintLength"><span class="hint-icon">●</span> কমপক্ষে ৮ অক্ষর</li>
                    <li id="hintMixed"><span class="hint-icon">●</span> বড় ও ছোট হাতের অক্ষর (Aa)</li>
                    <li id="hintLetter"><span class="hint-icon">●</span> কমপক্ষে ১টি অক্ষর</li>
                    <li id="hintNumber"><span class="hint-icon">●</span> কমপক্ষে ১টি সংখ্যা</li>
                    <li id="hintSymbol"><span class="hint-icon">●</span> কমপক্ষে ১টি স্পেশাল ক্যারেক্টার (!@#)</li>
                </ul>
            </div>

            <div class="field-group">
                <label for="password-confirm" class="field-label">
                    কনফার্ম পাসওয়ার্ড <span class="req">*</span>
                </label>
                <div class="field-wrap">
                    <i class="fa fa-lock field-icon" aria-hidden="true"></i>
                    <input
            ...
            <button type="submit" class="btn-login" id="resetBtn">
                ...
                <i class="fa fa-refresh" id="resetIcon" aria-hidden="true"></i>
                <span id="resetText">রিসেট পাসওয়ার্ড</span>
            </button>
...
<script>
    ...
    document.getElementById('password').addEventListener('input', function () {
        ...
        const checks = [
            { id: 'hintLength', pass: val.length >= 8 },
            { id: 'hintMixed',  pass: /[a-z]/.test(val) && /[A-Z]/.test(val) },
            { id: 'hintLetter', pass: /[a-zA-Z]/.test(val) },
            { id: 'hintNumber', pass: /[0-9]/.test(val) },
            { id: 'hintSymbol', pass: /[^a-zA-Z0-9]/.test(val) },
        ];

        checks.forEach(function (c) {
            el(c.id).classList.toggle('valid', c.pass);
        });
    });
</script>
